...
exports.getCommentsByPostId = exports.deleteCommentById = exports.updateComment = exports.createComment = void 0;
...
var createComment = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newComment, post, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                newComment = __assign({}, req.body);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, comment_1.create)(newComment)];
            case 2:
                post = _a.sent();
...
var updateComment = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, newComment, post, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, comment_1.update)(newComment, Number(id))];
            case 2:
                post = _a.sent();
...
var deleteCommentById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, comment_1.deleteComment)(Number(id))];
            case 2:
                comment = _a.sent();
...
var getCommentsByPostId = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, comment_1.getCommentsbyPostId)(Number(postId))];
            case 2:
                comments = _a.sent();
